...
--- Lua Script Settings
    ...
    --- Files & Folders
        ...
        util.require_natives("lib.heezylib.natives")
...
--- Main Lists
    ...
    menu.divider(hccc, TRANSLATE("Heist Control") .. " " .. HCVersion)

        local PERICO_HEIST = menu.list(hccc, TRANSLATE("Cayo Perico Heist"), {"hccp"}, "", function();  end)
        local CASINO_HEIST = menu.list(hccc, TRANSLATE("Diamond Casino Heist"), {"hccah"}, "", function(); end)
        local DOOMS_HEIST = menu.list(hccc, TRANSLATE("Doomsday Heist"), {"hcdooms"}, "", function(); end)
        local CLASSIC_HEISTS = menu.list(hccc, TRANSLATE("Classic Heist"), {"hcclassic"}, "", function(); end)
        local LS_ROBBERY = menu.list(hccc, TRANSLATE("LS Tuners Robbery"), {"hcls"}, "", function(); end)
        local ULP_MISSIONS = menu.list(hccc, TRANSLATE("ULP Missions"), {"hculp"}, "", function(); end)
        local TH_CONTRACT = menu.list(hccc, TRANSLATE("The Contract: Agency"), {"hcagc"}, "", function(); end)
        local MASTER_UNLOCKR = menu.list(hccc, TRANSLATE("Master Unlocker"), {"hcmu"}, "", function(); end)
        local TOOLS = menu.list(hccc, TRANSLATE("Tools"), {"hctool"}, "", function(); end)
        local INFOS = menu.list(hccc, TRANSLATE("Settings & About HC"), {"hcinfo"}, "", function(); end)
...
--- Cayo Perico Heist
    ...
    local CAYO_AUTO_PRST = menu.list(PERICO_HEIST, TRANSLATE("Automated Presets"), {}, TRANSLATE("- Remember to choose your preset outside the Submarine or in the Main Deck") .. "\n\n" .. TRANSLATE("- Remember to deactivate the preset at the end."), function(); end)
        ...
        menu.toggle(CAYO_AUTO_PRST, TRANSLATE("Quick Preset [1 ~ 4P]"), {"hccpquick"}, IsWorking(false), function(Toggle)
            ...
            if quickcp then
                NOTIFY(TRANSLATE("There are no secondary targets, only one primary target exists. Your goal is get it.") .. "\n\n" .. TRANSLATE("Leave activated until the end of the heist"))
            end
    ...
    local STANDARD_SET = menu.list(PERICO_HEIST, TRANSLATE("Standard Preset"), {}, TRANSLATE("- Remember to choose your preset outside the Submarine or in the Main Deck") .. "\n\n" .. TRANSLATE("- Remember to deactivate the preset at the end."), function(); end)
    ...
    local TELEPORT_CP = menu.list(PERICO_HEIST, TRANSLATE("Custom Teleport"), {}, "", function(); end)
        ...
        local CAYO_TELE_ISLAND = menu.list(TELEPORT_CP, TRANSLATE("Island"), {}, "", function(); end)
            ...
            ---
                ...
                CAYO_TELE_ISLAND_DRAINGE_1ST = menu.action(CAYO_TELE_ISLAND, TRANSLATE("Drainage"), {}, "", function()
                ...
                menu.action(CAYO_TELE_ISLAND, TRANSLATE("Ocean Safe Place"), {}, "", function()
    ...
    local PERICO_ADV = menu.list(PERICO_HEIST, TRANSLATE("Advanced Features"), {}, "", function(); end)
        ...
        local HSCUT_CP = menu.list(PERICO_ADV, TRANSLATE("Players Cut"), {}, "", function(); end)
            ...
            local PERICO_HOST_CUT = menu.list(HSCUT_CP, TRANSLATE("Your Cut"), {}, "", function(); end)
                ...
                CP_HOST_CUT = menu.slider(PERICO_HOST_CUT, TRANSLATE("Custom Payout"), {"hccphostcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local PERICO_P2_CUT = menu.list(HSCUT_CP, TRANSLATE("Player 2"), {}, "", function(); end)
                ...
                CP_2P_CUT = menu.slider(PERICO_P2_CUT, TRANSLATE("Custom Payout"), {"hccp2pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local PERICO_P3_CUT = menu.list(HSCUT_CP, TRANSLATE("Player 3"), {}, "", function(); end)
                ...
                CP_3P_CUT = menu.slider(PERICO_P3_CUT, TRANSLATE("Custom Payout"), {"hccp3pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local PERICO_P4_CUT = menu.list(HSCUT_CP, TRANSLATE("Player 4"), {}, "", function(); end)
                ...
                CP_4P_CUT = menu.slider(PERICO_P4_CUT, TRANSLATE("Custom Payout"), {"hccp4pcut"}, "(%)", 0, 1000, 100, 5, function(); end)

            ---
            
            menu.toggle_loop(HSCUT_CP, TRANSLATE("Set 100% to everyone"), {"hccpcutall100"}, IsWorking(false), function()
                menu.set_value(CP_HOST_CUT, 100)
                menu.set_value(CP_HOST_CUT_LOOP, true)
                menu.set_value(CP_2P_CUT, 100)
                menu.set_value(CP_2P_CUT_LOOP, true)
        ...
        menu.list_action(PERICO_ADV, TRANSLATE("Bag Capacity Modifier"), {"hccpbag"}, IsWorking(true) .. TRANSLATE("[Locally]"), {
            { TRANSLATE("Normal Bag Limit"), {"1p"} },
            { TRANSLATE("Simulate Bag to 2 players"), {"2p"} },
            { TRANSLATE("Simulate Bag to 3 players"), {"3p"} },
            { TRANSLATE("Simulate Bag to 4 players"), {"4p"} },
            { TRANSLATE("Infinite Bag"), {"inf"} },
        }, function(Index)
            if Index ~= 5 then
        ...
        menu.toggle_loop(PERICO_ADV, TRANSLATE("Skip Sewer Cutter"), {}, IsWorking(true) .. "Use with Cayo Perico Heist > Custom Teleport > Island > Drainage!", function() 
        ...
        menu.toggle_loop(PERICO_ADV, TRANSLATE("Open Plasma Glass Immediately"), {}, IsWorking(false), function()
            SET_FLOAT_LOCAL("fm_mission_controller_2020", 28736 + 3, 100)
        end, function()
            SET_FLOAT_LOCAL("fm_mission_controller_2020", 28736 + 3, 0)
        end)

        menu.toggle_loop(PERICO_ADV, TRANSLATE("Bypass Plasma Glass Cutter Heat"), {}, IsWorking(false), function()
        ...
        CP_REM_FEE = menu.toggle_loop(PERICO_ADV, TRANSLATE("Remove Fencing Fee & Pavel Cut"), {"hccpremfee"}, IsWorking(true) .. TRANSLATE("Leave activated until the end of the heist"), function()
        ...
        menu.action(PERICO_ADV, TRANSLATE("Auto-finish Primary Target"), {"hccpfintar"}, IsWorking(false), function() -- Locals from https://www.unknowncheats.me/forum/3418914-post13398.html, Values from Heist Control for Nightfall
            SET_INT_LOCAL("fm_mission_controller_2020", 28735, 5) -- CutterStage
            SET_INT_LOCAL("fm_mission_controller_2020", 28736, 3) -- BitCheck
        end)

        menu.action(PERICO_ADV, TRANSLATE("Remove Drainage Pipe"), {"hccprempipe"}, "", function() -- Thanks to help me to code, Sapphire#6031
    ...
    menu.list_action(PERICO_HEIST, TRANSLATE("Heist Vehicles"), {"hccpveh"}, "", {
        { TRANSLATE("Submarine KOSATKA"), {"kosatka"} },
        { TRANSLATE("Plane ALKONOST"), {"alkonost"} },
        { TRANSLATE("Plane VELUM"), {"velum"} },
        { TRANSLATE("Helicopter STEALTH ANNIHILATOR"), {"annihilator"} },
        { TRANSLATE("Boat PATROL BOAT"), {"patrol"} },
        { TRANSLATE("Boat LONGFIN"), {"longfin"} },
        { TRANSLATE("Unlock All Vehicles"), {"all"} },
    }, function(Index)
        if Index == 1 then
            STAT_SET_INT("H4_MISSIONS", 65283)
        elseif Index == 2 then
    ...
    menu.list_action(PERICO_HEIST, TRANSLATE("Secondary Target"), {"hccpsectar"}, TRANSLATE("When using this method, the percentage and final payment is random!"), {
    ...
    menu.list_action(PERICO_HEIST, TRANSLATE("Equipments Spawn Location"), {"hccpequip"}, TRANSLATE("- Guard Clothing") .. "\n" .. TRANSLATE("- Bolt Cutters"), { 
    ...
    local MORE_OPTIONS = menu.list(PERICO_HEIST, TRANSLATE("Others"), {}, "", function(); end)
        ...
        menu.action(MORE_OPTIONS, TRANSLATE("Unlock Heist Awards"), {}, "", function()
        ...
        menu.action(MORE_OPTIONS, TRANSLATE("Complete all Missions only"), {}, "", function()
            STAT_SET_INT("H4_MISSIONS", -1)
            STAT_SET_INT("H4CNF_APPROACH", -1)
            STAT_SET_INT("H4CNF_BS_ENTR", 63)
        ...
        menu.action(MORE_OPTIONS, TRANSLATE("Force the longest final Cutscene"), {}, TRANSLATE("Keep in mind that you must use this option before starting the Heist"), function()
...
--- Diamond Casino Heist
    ...
    local CASINO_PRESETS = menu.list(CASINO_HEIST, TRANSLATE("Automated Presets"), {}, "", function(); end)
        ...
        local CASINO_PRESETS_DIAMOND = menu.list(CASINO_PRESETS, TRANSLATE("Diamond"), {}, TRANSLATE("$3.5 Millions & For All Players"), function(); end)

            menu.toggle(CASINO_PRESETS_DIAMOND, TRANSLATE("Silent & Sneaky Approach"), {"hccahdiasil"}, IsWorking(true) .. TRANSLATE("ALWAYS choose Low Level Buyer!"), function(Toggle)
                DiamondST = Toggle
    ...
    local CAH_ADVCED = menu.list(CASINO_HEIST, TRANSLATE("Advanced Features"), {}, "", function(); end)
        ...
        local CAH_PLAYER_CUT = menu.list(CAH_ADVCED, TRANSLATE("Players Cut"), {}, "", function(); end)
            ...
            local CAH_NON_YOUR_CUT = menu.list(CAH_PLAYER_CUT, TRANSLATE("Your Cut (Non-Host)"), {}, "", function(); end)
                ...
                CAH_NON_HOST_CUT = menu.slider(CAH_NON_YOUR_CUT, TRANSLATE("Custom Payout"), {"hccahnonhost"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local CAH_PLAYER_HOST = menu.list(CAH_PLAYER_CUT, TRANSLATE("Your Cut"), {}, "", function(); end)
                ...
                CAH_1P_CUT = menu.slider(CAH_PLAYER_HOST, TRANSLATE("Custom Payout"), {"hccah1pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local CAH_PLAYER_TWO = menu.list(CAH_PLAYER_CUT, TRANSLATE("Player 2"), {}, "", function(); end)
                ...
                CAH_2P_CUT = menu.slider(CAH_PLAYER_TWO, TRANSLATE("Custom Payout"), {"hccah2pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local CAH_PLAYER_THREE = menu.list(CAH_PLAYER_CUT, TRANSLATE("Player 3"), {}, "", function(); end)
                ...
                CAH_3P_CUT = menu.slider(CAH_PLAYER_THREE, TRANSLATE("Custom Payout"), {"hccah3pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
            ...
            local CAH_PLAYER_FOUR = menu.list(CAH_PLAYER_CUT, TRANSLATE("Player 4"), {}, "", function(); end)
                ...
                CAH_4P_CUT = menu.slider(CAH_PLAYER_FOUR, TRANSLATE("Custom Payout"), {"hccah4pcut"}, "(%)", 0, 1000, 100, 5, function(); end)

            ---

            menu.toggle_loop(CAH_PLAYER_CUT, TRANSLATE("Set 100% to everyone"), {"hccahall100"}, IsWorking(false), function()
                menu.set_value(CAH_1P_CUT, 100)
                menu.set_value(CAH_1P_CUT_LOOP, true)
                menu.set_value(CAH_2P_CUT, 100)
                menu.set_value(CAH_2P_CUT_LOOP, true)
        ...
        menu.toggle_loop(CAH_ADVCED, TRANSLATE("Skip Hacking"), {}, IsWorking(true) .. TRANSLATE("Works on both of sorts: Fingerprint and Keypad"), function()
        ...
        menu.action(CAH_ADVCED, TRANSLATE("Instant Vault Door Laser"), {"hccahinsvault"}, IsWorking(false), function() -- Locals from https://www.unknowncheats.me/forum/3418914-post13398.html, Values from Heist Control for Nightfall
    ...
    local TELEPORT_CAH = menu.list(CASINO_HEIST, TRANSLATE("Custom Teleport"), {}, "", function(); end)
        ...
        menu.divider(TELEPORT_CAH, TRANSLATE("Inside"))
            ...
            menu.action(TELEPORT_CAH, TRANSLATE("Planning Boards"), {}, "", function()
                TELEPORT(2711.773, -369.458, -54.781)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Garage Exit"), {}, "", function()
                TELEPORT(2677.237, -361.494, -55.187)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Waste Disposal"), {}, "", function()
                TELEPORT(2542.052, -214.3084, -58.722965)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Staff Lobby"), {}, "", function()
                TELEPORT(2547.9192, -273.16754, -58.723003)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("2-Keypad Door"), {}, "", function()
                TELEPORT(2465.4746, -279.2276, -70.694145)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Inside Vault"), {}, "", function()
                TELEPORT(2515.1252, -238.91661, -70.73713)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Pre-Inside Vault"), {}, "", function()
                TELEPORT(2497.5098, -238.50768, -70.7388)
            end)
            menu.action(TELEPORT_CAH, TRANSLATE("Daily Bonus Room"), {}, "", function()
        ...
        menu.divider(TELEPORT_CAH, TRANSLATE("Outside"))
            ...
            menu.action(TELEPORT_CAH, TRANSLATE("Main Gate"), {}, "", function()
    ...
    local CASINO_BOARD1 = menu.list(CASINO_HEIST, TRANSLATE("Heist Planning [Board 1]"), {}, "", function(); end)
        ...
        menu.list_select(CASINO_BOARD1, TRANSLATE("P.O.I & Access Points"), {"hccahpoi"}, TRANSLATE("Change your session to apply!"), {
            { "Scope(d)", {"scope"} },
            { "Unscope(d)", {"unscope"} },
    ...
    local CASINO_BOARD2 = menu.list(CASINO_HEIST, TRANSLATE("Heist Planning [Board 2]"), {}, "", function(); end)
        ...
        menu.list_action(CASINO_BOARD2, TRANSLATE("Choose Mask"), {"hccahmask"}, "", {
            { TRANSLATE("Remove Mask"), {"remove"} },
            { TRANSLATE("Geometric"), {"geometric"} },
            { TRANSLATE("Hunter"), {"hunter"} },
            { TRANSLATE("Oni Half Mask"), {"onihalf"} },
            { TRANSLATE("Emoji"), {"emoji"} },
            { TRANSLATE("Ornate Skull"), {"ornate"} },
            { TRANSLATE("Lucky Fruit"), {"lucky"} },
            { TRANSLATE("Guerilla"), {"guerilla"} },
            { TRANSLATE("Clown"), {"clown"} },
            { TRANSLATE("Animal"), {"animal"} },
            { TRANSLATE("Riot"), {"riot"} },
            { TRANSLATE("Oni"), {"oni"} },
            { TRANSLATE("Hockey"), {"hockey"} },
        }, function(Index)
            if Index == 1 then
        ...
        menu.click_slider(CASINO_BOARD2, TRANSLATE("Unlock Scan Card Level"), {"hccahcard"}, "", 0, 2, 2, 1, function(Value)
            STAT_SET_INT("H3OPT_KEYLEVELS", Value)
        end)
        menu.click_slider(CASINO_BOARD2, TRANSLATE("Duggan Guards"), {"hccahguard"}, TRANSLATE("0 - Strongest Guards") .. "\n" .. TRANSLATE("3 - Weakest Guards"), 0, 3, 3, 1, function(Value)
    ...
    menu.list_action(CASINO_HEIST, TRANSLATE("Board Loader & Unloader"), {"hccahboard"}, "", {
        { TRANSLATE("Load all Boards"), {"load"} },
        { TRANSLATE("Unload all Boards"), {"unload"} },
    }, function(Index)
        if Index == 1 then
    ...
    local CASINO_MORE = menu.list(CASINO_HEIST, TRANSLATE("Others"), {}, "", function(); end)
        ...
        menu.action(CASINO_MORE, TRANSLATE("Remove Heist Prepare Cooldown"), {}, "Note that this doesn't bypass server-side cooldown time, just bypassing payment.", function()
            STAT_SET_INT("H3_COMPLETEDPOSIX", -1)
            STAT_SET_INT("MPPLY_H3_COOLDOWN", -1)
        end)

        menu.action(CASINO_MORE, TRANSLATE("Skip Agatha Baker missions to the last one"), {}, "", function()
...
--- Doomsday Heist
    ...
    local DDHEIST_PLYR_MANAGER = menu.list(DOOMS_HEIST, TRANSLATE("Players Cut"), {}, "", function(); end)
        ...
        local DDHEIST_HOST_MANAGER = menu.list(DDHEIST_PLYR_MANAGER, TRANSLATE("Your Cut"), {}, "", function(); end)
            ...
            DOOMS_HOST_CUT = menu.slider(DDHEIST_HOST_MANAGER, TRANSLATE("Custom Payout"), {"hcdooms1pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
        ...
        local DDHEIST_PLAYER2_MANAGER = menu.list(DDHEIST_PLYR_MANAGER, TRANSLATE("Player 2"), {}, "", function(); end)
            ...
            DOOMS_2P_CUT = menu.slider(DDHEIST_PLAYER2_MANAGER, TRANSLATE("Custom Payout"), {"hcdooms2pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
        ...
        local DDHEIST_PLAYER3_MANAGER = menu.list(DDHEIST_PLYR_MANAGER, TRANSLATE("Player 3"), {}, "", function(); end)
            ...
            DOOMS_3P_CUT = menu.slider(DDHEIST_PLAYER3_MANAGER, TRANSLATE("Custom Payout"), {"hcdooms3pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
        ...
        local DDHEIST_PLAYER4_MANAGER = menu.list(DDHEIST_PLYR_MANAGER, TRANSLATE("Player 4"), {}, "", function(); end)
            ...
            DOOMS_4P_CUT = menu.slider(DDHEIST_PLAYER4_MANAGER, TRANSLATE("Custom Payout"), {"hcdooms4pcut"}, "(%)", 0, 1000, 100, 5, function(); end)
    ...
    menu.action(DOOMS_HEIST, TRANSLATE("Unlock All Doomsday Heist"), {}, "", function()
    ...
    menu.action(DOOMS_HEIST, TRANSLATE("Complete all preparations (Not Setup)"), {}, "", function()
        STAT_SET_INT("GANGOPS_FM_MISSION_PROG", -1)
    end)
...
--- Classic Heist
    ...
    local FLEECA_HEIST = menu.list(CLASSIC_HEISTS, TRANSLATE("Fleeca Heist"), {}, "", function(); end)
        ...
        menu.divider(FLEECA_HEIST, TRANSLATE("Your Payout (Millions)"))
        
            menu.toggle_loop(FLEECA_HEIST, TRANSLATE("Enable"), {"hcfleecapayloop"}, IsWorking(true) .. TRANSLATE("Will be applied only to you & have to host") .. "\n\n" .. TRANSLATE("- Only do this only one time or twice in less than 24 hours.") .. "\n" .. TRANSLATE("- Otherwise, you can be banned!"), function(Toggle)
                local Value = 100
            ...
            FLEECA_PAYOUT = menu.slider(FLEECA_HEIST, TRANSLATE("Modify Payout Amount"), {"hcfleecapay"}, "", 5, 15, 15, 5, function(Value); end)

        ---

        menu.divider(FLEECA_HEIST, TRANSLATE("Others"))

            menu.toggle_loop(FLEECA_HEIST, TRANSLATE("Complete all Setup"), {}, TRANSLATE("You may need to choose a Heist and then complete the first setup, activated until then"), function()
...
--- LS Robbery
    ...
    menu.toggle_loop(LS_ROBBERY, TRANSLATE("Modify Contracts payout - $1 MILLIONs"), {"hcls1m"}, IsWorking(true) .. TRANSLATE("[Locally]") .. "\n\n" .. TRANSLATE("Always keep this option actived before starting a contract"), function()
    ...
    menu.action(LS_ROBBERY, TRANSLATE("Complete missions (only)"), {"hclscomplete"}, "", function()
        STAT_SET_INT("TUNER_GEN_BS", -1)
    end)
    
    local ROBBERY_RESETER = menu.list(LS_ROBBERY, TRANSLATE("Others"), {}, "", function(); end)
    
        menu.action(ROBBERY_RESETER, TRANSLATE("Reset Missions (only)"), {"hclsresetmisson"}, "", function()
            STAT_SET_INT("TUNER_GEN_BS", 12467)
        end)
        menu.action(ROBBERY_RESETER, TRANSLATE("Reset Contracts"), {"hclsresetcontract"}, "", function()
            STAT_SET_INT("TUNER_GEN_BS", 8371)
            STAT_SET_INT("TUNER_CURRENT", -1)
        end)
        menu.action(ROBBERY_RESETER, TRANSLATE("Reset Total Gains & Completed Missions"), {"hclsresetgain"}, "", function()
...
--- The Contract: Agency
    ...
    local CONTRACT_VIP = menu.list(TH_CONTRACT, TRANSLATE("VIP Contract: Dr.Dre"), {}, TRANSLATE("The feature to be worked properly, you may need to log out of F.Clinton & Partner"), function(); end)
        ...
        menu.list_action(CONTRACT_VIP, TRANSLATE("South Central Leak"), {"hcagccentral"}, TRANSLATE("Change your session to apply!"), {
            ...
            { TRANSLATE("Final Contract: Don't Fuck with Dre"), {"final"} },
        }, function(Index)
            if Index == 1 then
        ...
        menu.toggle_loop(TH_CONTRACT, TRANSLATE("Modify Final Contract Payout (2 Millions)"), {"hcagcpay"}, IsWorking(true) .. TRANSLATE("[Locally]"), function()
            SET_INT_GLOBAL(262145 + 31735, 2000000) -- -2108119120
        end, function()
            SET_INT_GLOBAL(262145 + 31735, 1000000)
        end)

        menu.toggle_loop(TH_CONTRACT, TRANSLATE("Skip Cooldown of Payphone hits & contracts"), {"hcagccoolhit"}, IsWorking(true) .. TRANSLATE("Make sure enabled before starting any contract or hit."), function() -- Credit goes to Da Chaos#9262
        ...
        menu.toggle_loop(TH_CONTRACT, TRANSLATE("Remove Security Missions Cooldown"), {"hcagcremcool"}, IsWorking(false), function()
...
--- Master Unlocker
    ...
    local DLC_UNLOCKER = menu.list(MASTER_UNLOCKR, TRANSLATE("DLCs"), {}, "", function(); end)
        ...
        local ARENA_TOOL = menu.list(DLC_UNLOCKER, TRANSLATE("Arena Wars DLC"), {}, "", function(); end)
            ...
            menu.action(ARENA_TOOL, TRANSLATE("Unlock all Arena Wars Trophy and Toys"), {}, "", function()
        ...
        local TUNERS_DLC = menu.list(DLC_UNLOCKER, TRANSLATE("LS Tuners DLC"), {}, "", function(); end)
            ...
            menu.action(TUNERS_DLC, TRANSLATE("Unlock Drip Fed Outfits"), {}, IsWorking(false), function()
    ...
    local UNLOCKER_BUILDING = menu.list(MASTER_UNLOCKR, TRANSLATE("Buildings"), {}, "", function(); end)
        ...
        local ARCADE_TOOL = menu.list(UNLOCKER_BUILDING, TRANSLATE("Arcade Unlockers"), {}, "", function(); end)
            ...
            menu.action(ARCADE_TOOL, TRANSLATE("Unlock Arcade Trophys and Toys"), {}, "", function()
                STAT_SET_INT("AWD_PREPARATION", 40)
                STAT_SET_INT("AWD_ASLEEPONJOB", 20)
                STAT_SET_INT("AWD_DAICASHCRAB", 100000)
                STAT_SET_INT("AWD_BIGBRO", 40)
        ...
        menu.action(UNLOCKER_BUILDING, TRANSLATE("Add cosmetics items to the Office/MC"), {}, "To apply, sell special crate or vehicle cargo and change your session!", function()
    ...
    local UNLOCKER_ANNIVERSARY = menu.list(MASTER_UNLOCKR, TRANSLATE("Special Anniversaries"), {}, "", function(); end)
        ...
        local XMAS_FEATURES = menu.list(UNLOCKER_ANNIVERSARY, TRANSLATE("Christmas"), {}, "", function(); end)
            ...
            menu.toggle_loop(XMAS_FEATURES, TRANSLATE("Bypass Christmas Clothing"), {"hcxmas"}, IsWorking(true) .. TRANSLATE("You must always keep this feature activated to wear!"), function()
        ...
        menu.action(UNLOCKER_ANNIVERSARY, TRANSLATE("Valentine"), {}, IsWorking(false), function()
    ...
    local UNLOCKER_SHIRT_HAT = menu.list(MASTER_UNLOCKR, TRANSLATE("Clothes"), {}, "", function(); end)
        ...
        menu.action(UNLOCKER_SHIRT_HAT, "Unlock Sasquatch Outfit", {}, IsWorking(false), function() -- https://www.unknowncheats.me/forum/3492512-post53.html
    ...
    local UNLOCKER_VEHICLE = menu.list(MASTER_UNLOCKR, TRANSLATE("Vehicles"), {}, "", function(); end)
        ...
        menu.action(UNLOCKER_VEHICLE, TRANSLATE("Unlock some vehicles trade price"), {}, "", function()
        ...
        menu.action(UNLOCKER_VEHICLE, TRANSLATE("Unlock Shotaro"), {}, "", function()
    ...
    local SPECIAL_WEAPON = menu.list(MASTER_UNLOCKR, TRANSLATE("Weapons"), {}, "", function(); end)
        ...
        menu.action(SPECIAL_WEAPON, "Service Carbine", {}, IsWorking(false), function()
    ...
    menu.action(MASTER_UNLOCKR, TRANSLATE("Returning Bonus"), {}, IsWorking(false), function()
...
--- Tools
    ...
    local TUNABLES = menu.list(TOOLS, TRANSLATE("Tunables"), {}, "", function(); end) -- Almost non-credited global variables from: https://www.unknowncheats.me/forum/3337151-post1560.html
        ...
        local TUNABLES_CD = menu.list(TUNABLES, TRANSLATE("Remove Cooldowns"), {}, "", function(); end)
            ...
            menu.divider(TUNABLES_CD, TRANSLATE("Resupply Delay"))
            ...
            menu.divider(TUNABLES_CD, TRANSLATE("Buy & Sell"))
            ...
            menu.divider(TUNABLES_CD, TRANSLATE("Others"))
                ...
                menu.toggle_loop(TUNABLES_CD, TRANSLATE("Client Job"), {"hccoolclient"}, IsWorking(false), function()
        ...
        local TUNABLES_MUT = menu.list(TUNABLES, TRANSLATE("Multipliers"), {}, "", function(); end)
            ...
            menu.divider(TUNABLES_MUT, TRANSLATE("LS Car Meet"))
                ...
                menu.toggle_loop(TUNABLES_MUT, TRANSLATE("LS Car Meet Track"), {"hcmuttrack"}, IsWorking(false), function()
        ...
        local TUNABLES_SEL = menu.list(TUNABLES, TRANSLATE("Bunker Mission Selector"), {}, "", function(); end)
            ...
            menu.divider(TUNABLES_SEL, TRANSLATE("Steal Supplies"))
                ...
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("The Dune Buggy"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 2)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Police Riot"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 3)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Mine"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 4)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("The Technical Aqua"), {}, IsWorking(false), function()
                ...
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("LSIA"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 8)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Merryweather HQ"), {}, IsWorking(false), function()
                ...
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Del Perro Beach"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 11)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Cholla Springs Avenue"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 12)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("Chupacabra Street"), {}, IsWorking(false), function()
            ...
            menu.divider(TUNABLES_SEL, TRANSLATE("Sell Weapons"))
                ...
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("HVY Insurgent Pick Up"), {}, IsWorking(false), function()
                    SET_INT_GLOBAL(2815059 + 5195 + 344, 14)
                end)
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("HVY Insurgent (Normal)"), {}, IsWorking(false), function()
                ...
                menu.toggle_loop(TUNABLES_SEL, TRANSLATE("HVY Insurgent Pick Up (Custom)"), {}, IsWorking(false), function()
        ...
        local TUNABLES_RSU = menu.list(TUNABLES, TRANSLATE("Remove Other Cost"), {}, "", function(); end)
            ...
            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("Repair Vehicle Cargo"), {"hcremcostveh"}, IsWorking(true) .. TRANSLATE("When you sell vehicle, block paying related repair."), function() 
            ...
            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("Ron's Cut of Air Freight Cargo"), {"hcremcostron"}, IsWorking(false), function()
                SET_FLOAT_GLOBAL(262145 + 22821, 0) -- 1232447926
            end, function()
                SET_FLOAT_GLOBAL(262145 + 22821, 0.025)
            end)

            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("Tony's Cut of Nightclub"), {"hcremcosttony"}, IsWorking(false), function() -- https://www.unknowncheats.me/forum/3347568-post13086.html
                SET_FLOAT_GLOBAL(262145 + 24524, 0) -- -1002770353
            end, function()
                SET_FLOAT_GLOBAL(262145 + 24524, 0.1)
            end)

            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("Resupply MC Business"), {"hcremcostresupmc"}, IsWorking(true) .. "Make sure use this before accessing the laptop!", function()
                SET_INT_GLOBAL(262145 + 18998, 1000) -- joaat("BIKER_PURCHASE_SUPPLIES_COST_PER_SEGMENT")
            end, function()
                SET_INT_GLOBAL(262145 + 18998, 15000)
            end)

            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("Resupply Bunker"), {"hcremcostresupbunker"}, IsWorking(true) .. "Make sure use this before accessing the laptop!", function()
            ...
            menu.toggle_loop(TUNABLES_RSU, TRANSLATE("CEO Abilities") .. " & ".. TRANSLATE("CEO Vehicles"), {}, IsWorking(false), function() -- Credit goes to Professor#4478's Kiddions Lua
        ...
        local TUNABLES_CAH = menu.list(TUNABLES, TRANSLATE("Casino Services: Chips") .. " " .. TRANSLATE("[Risky]"), {}, TRANSLATE("Make sure don't buy chip more than 1.5M per a day (real-time). Otherwise, you can be banned!"), function(); end)
            ...
            menu.divider(TUNABLES_CAH, TRANSLATE("Others"))
                ...
                CASINO_MEMBERSHIP = menu.action_slider(TUNABLES_CAH, TRANSLATE("Change Membership of Casino"), {}, IsWorking(true) .. "Your Membership of Casino: " .. CasinoMembership, {
                    "Normal",
                    "VIP",
                }, function(Index)
        ...
        local TUNABLES_OTH = menu.list(TUNABLES, TRANSLATE("Others"), {}, "", function(); end)
            ...
            menu.toggle_loop(TUNABLES_OTH, TRANSLATE("Refill Snacks & Armours Automatically"), {}, "", function()
        ...
        menu.slider(TUNABLES, TRANSLATE("Custom Money Remover"), {"hcmoneyrem"}, IsWorking(true) .. TRANSLATE("Easy way to remove GTAO bank account money"), 0, 2000000000, 5000, 10000, function(Value)
    ...
    local AFK_MONEY = menu.list(TOOLS, TRANSLATE("AFK Money") .. " " .. TRANSLATE("[Risky]"), {}, TRANSLATE("Methods are safe to use, but if you earn too much money, can be banned. Always use at own your risk."), function(); end)

        menu.divider(AFK_MONEY, TRANSLATE("Cooldown Time [Sec]"))
        ...
        menu.divider(AFK_MONEY, TRANSLATE("AFK Money") .. " " .. TRANSLATE("[Risky]"))
            ...
            menu.toggle_loop(AFK_MONEY, TRANSLATE("Auto Time Trial"), {"hcautotrial"}, "", function() -- Tbh, an idea from X-Force, but all coded by me
                ...
                menu.trigger_commands("hctimercustom on")
                NOTIFY(TRANSLATE("Playing Time Trial one time is done! Waiting for cooldown time..."))
                util.yield(500)
                while menu.get_value(TIMER_CUSTOM) do
                    util.yield()
                end
            ...
            menu.toggle_loop(AFK_MONEY, TRANSLATE("Auto Sightseer"), {"hcautosightseer"}, IsWorking(true) .. TRANSLATE("Also works playing with your associates. Just hire the user to do it.") .. "\n\n" .. TRANSLATE("If you expect Transaction Error, stop using this feature and have to restart your game to fix it."), function()              
                if players.get_boss(players.user()) == -1 then
                    menu.trigger_commands("ceostart")
                    NOTIFY("Starting CEO... Please wait for a few secs.")
                    util.yield(5000)
    ...
    local INSTANT_FINISH = menu.list(TOOLS, TRANSLATE("Instant Finish Heists & Others"), {"hcinsfin"}, "", function(); end)
        ...
        menu.divider(INSTANT_FINISH, TRANSLATE("Heists"))
            ...
            menu.action(INSTANT_FINISH, TRANSLATE("Cayo / Tuners / ULP / Agency"), {"hcinsfincp"}, IsWorking(false) .. TRANSLATE("Note that not working on ULP Missions - Superyatch"), function() -- Done Cayo Perico Heist Instantly: https://www.unknowncheats.me/forum/3472329-post13554.html
        ...
        menu.divider(INSTANT_FINISH, TRANSLATE("Others"))
            ...
            menu.action(INSTANT_FINISH, TRANSLATE("Air Cargo"), {"hcinsfinac"}, IsWorking(true) .. "[Selling Only]", function() -- https://www.unknowncheats.me/forum/3513482-post37.html
    ...
    local COOLDOWN_TIMER = menu.list(TOOLS, TRANSLATE("Heist Cooldown Timer"), {}, TRANSLATE("When set time passed, HC will let you know heist cooldown has been passed."), function(); end)
        ...
        menu.divider(COOLDOWN_TIMER, TRANSLATE("Settings"))
            ...
            menu.slider(COOLDOWN_TIMER, TRANSLATE("Set Custom Time"), {"hctimertime"}, "", 0, 259200, 1200, 60, function(Value)
        ...
        menu.divider(COOLDOWN_TIMER, TRANSLATE("Heist Cooldown Timer"))
            ...
            TIMER_CAYO = menu.toggle(COOLDOWN_TIMER, TRANSLATE("Cayo Perico Heist"), {"hctimercp"}, "", function()
                ...
                while menu.get_value(TIMER_CAYO) do
                    if TimerCayoTotal == 0 then
                        NOTIFY(TRANSLATE("Cayo Perico Heist") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_CASINO = menu.toggle(COOLDOWN_TIMER, TRANSLATE("Diamond Casino Heist"), {"hctimercah"}, "", function()
                ...
                while menu.get_value(TIMER_CASINO) do
                    if TimerCasinoTotal == 0 then
                        NOTIFY(TRANSLATE("Diamond Casino Heist") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_DOOMS = menu.toggle(COOLDOWN_TIMER, TRANSLATE("Doomsday Heist"), {"hctimerdooms"}, "", function()
                ...
                while menu.get_value(TIMER_DOOMS) do
                    if TimerDoomsTotal == 0 then
                        NOTIFY(TRANSLATE("Doomsday Heist") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_CLASSIC = menu.toggle(COOLDOWN_TIMER, TRANSLATE("Classic Heist"), {"hctimerclassic"}, "", function()
                ...
                while menu.get_value(TIMER_CLASSIC) do
                    if TimerClassicTotal == 0 then
                        NOTIFY(TRANSLATE("Classic Heist") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_ROBBERY = menu.toggle(COOLDOWN_TIMER, TRANSLATE("LS Tuners Robbery"), {"hctimerrobbery"}, "", function()
                ...
                while menu.get_value(TIMER_ROBBERY) do
                    if TimerRobberyTotal == 0 then
                        NOTIFY(TRANSLATE("LS Tuners Robbery") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_AGENCY = menu.toggle(COOLDOWN_TIMER, TRANSLATE("The Contract: Agency"), {"hctimeragency"}, "", function()
                ...
                while menu.get_value(TIMER_AGENCY) do
                    if TimerAgencyTotal == 0 then
                        NOTIFY(TRANSLATE("The Contract: Agency") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
            ...
            TIMER_CUSTOM = menu.toggle(COOLDOWN_TIMER, TRANSLATE("Custom Heist"), {"hctimercustom"}, "", function()
                ...
                while menu.get_value(TIMER_CUSTOM) do
                    if TimerCustomTotal == 0 then
                        NOTIFY(TRANSLATE("Custom Heist") .. " - " .. TRANSLATE("Cooldown time passed, you can play the heist again!"))
    ...
    local NEAR_PED_CAM = menu.list(TOOLS, TRANSLATE("Manage Near Peds & Cams"), {}, "", function(); end)

        menu.divider(NEAR_PED_CAM, TRANSLATE("Settings"))
            
            IS_HOSTILE_PED = menu.toggle(NEAR_PED_CAM, TRANSLATE("Work only to hostile peds"), {}, TRANSLATE("Enabled: Ped options work only to hostile peds") .. "\n\n" .. TRANSLATE("Disabled: Ped options work to all peds"), function() end)
    ...
    local REQ_SERVICE = menu.list(TOOLS, TRANSLATE("Request Services"), {}, "", function(); end) -- All from decompiled scripts found by me except credited one
        ...
        menu.action(REQ_SERVICE, TRANSLATE("LJT's Airstrike"), {"hcreqairstrike"}, IsWorking(false), function() -- https://github.com/Primexz/GTA-Monopol_ModMenu
            SET_INT_GLOBAL(2815059 + 4455, 1) -- am_contact_requests.c
        end)
        menu.action(REQ_SERVICE, TRANSLATE("Ammunation Supply"), {"hcreqsupply"}, IsWorking(false), function() -- https://github.com/Primexz/GTA-Monopol_ModMenu
            SET_INT_GLOBAL(2815059 + 874, 1) -- am_contact_requests.c
        end)
        menu.action(REQ_SERVICE, TRANSLATE("Boat Pickup"), {"hcreqboatpickup"}, IsWorking(false), function() -- https://github.com/Primexz/GTA-Monopol_ModMenu
            SET_INT_GLOBAL(2815059 + 875, 1) -- am_contact_requests.c
        end)

    ---

    local INFO_SPOOFING = menu.list(TOOLS, TRANSLATE("Info Spoofing"), {}, TRANSLATE("Change your session to apply!"), function(); end) -- Thanks to help me find this, Anry#4040
        ...
        local INFO_SPOOFING_MONEY = menu.list(INFO_SPOOFING, TRANSLATE("Total Money"), {}, "", function(); end) -- freemode.c, joaat("mpply_most_favorite_station")
        ...
        local INFO_SPOOFING_KILL = menu.list(INFO_SPOOFING, TRANSLATE("Kills"), {}, "", function(); end) -- freemode.c, joaat("mpply_kills_players")
        ...
        local INFO_SPOOFING_DEATH = menu.list(INFO_SPOOFING, TRANSLATE("Deaths"), {}, "", function(); end)
            ...
            menu.toggle_loop(INFO_SPOOFING_DEATH, TRANSLATE("Enable"), {}, IsWorking(false), function() -- freemode.c, joaat("mpply_deaths_player")
    ...
    local BUSINESS_UPGRADE = menu.list(TOOLS, TRANSLATE("Business Upgrade States"), {}, "", function(); end) -- All stats name credit goes to Raid Control for X-Force
        ...
        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Document"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES4")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES4_1")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES4_2")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Weed"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES3")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES3_1")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES3_2")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Counterfit"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES2")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES2_1")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES2_2")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Meth"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES1")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES1_1")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES1_2")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Cocaine"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES0")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES0_1")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("FACTORYUPGRADES0_2")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Bunker"), {}, "", {
            { TRANSLATE("Equipment Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_EQUIPMENT")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_STAFF")) },
            { TRANSLATE("Secuirity Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_SECURITY")) },
            { TRANSLATE("Decor Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_DECOR")) },
            { TRANSLATE("Firing Range Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_FIRING_RANGE")) },
            { TRANSLATE("Gunlocker Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_GUNLOCKER")) },
            { TRANSLATE("Personal Quarters Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_SAVEBED")) },
            { TRANSLATE("Transportation Upgrade") .. ": " .. CHECK(STAT_GET_INT("BUNKER_TRANSPORTATION")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Arcade"), {}, "", {
            { TRANSLATE("Drone Station") .. ": " .. CHECK(STAT_GET_INT("ARCADE_DRON_ST")) },
            { TRANSLATE("Business Hub") .. ": " .. CHECK(STAT_GET_INT("ARCADE_BUS_HUB")) },
            { TRANSLATE("Floor") .. ": " .. CHECK(STAT_GET_INT("ARCADE_FLOOR")) },
            { TRANSLATE("Style") .. ": " .. CHECK(STAT_GET_INT("ARCADE_CEILING")) },
            { TRANSLATE("Wall") .. ": " .. CHECK(STAT_GET_INT("ARCADE_WALL")) },
            { TRANSLATE("Personal Quarters Upgrade") .. ": " .. CHECK(STAT_GET_INT("ARCADE_PERSONAL_QUARTERS")) },
            { TRANSLATE("Garage") .. ": " .. CHECK(STAT_GET_INT("ARCADE_GARAGE")) },
            { TRANSLATE("Neon Lights") .. ": " .. CHECK(STAT_GET_INT("ARCADE_NEON_LIGHTS")) },
            { TRANSLATE("High Score Screen") .. ": " .. CHECK(STAT_GET_INT("ARCADE_SCREENS")) },
        }, function(); end)

        menu.list_action(BUSINESS_UPGRADE, TRANSLATE("Nightclub"), {}, "", {
            { TRANSLATE("Style") .. ": " .. CHECK(STAT_GET_INT("NIGHTCLUB_STYLE")) },
            { TRANSLATE("Lighting") .. ": " .. CHECK(STAT_GET_INT("NIGHTCLUB_LIGHTING")) },
            { TRANSLATE("Dancers") .. ": " .. CHECK(STAT_GET_INT("NIGHTCLUB_MOD_4")) },
            { TRANSLATE("Staff Upgrade") .. ": " .. CHECK(STAT_GET_INT("NIGHTCLUB_MOD_5")) },
            { TRANSLATE("Paid DJs") .. ": " .. CHECK(STAT_GET_INT("NIGHTCLUB_MOD_6")) },
        }, function(); end)

    ---

    local STAT_EDITOR_READER = menu.list(TOOLS, TRANSLATE("Stat Editor & Reader"), {}, "", function(); end)

        local PRESET_STAT_EDITOR = menu.list(STAT_EDITOR_READER, TRANSLATE("Presets Stat Editor"), {}, "", function(); end)
            ...
            local PLAYTIME_EDITOR = menu.list(PRESET_STAT_EDITOR, TRANSLATE("Playtime"), {}, "", function(); end)
                ...
                menu.divider(PLAYTIME_EDITOR, TRANSLATE("Modify Stat"))
                    ...
                    PLAYTIME_DAY = menu.slider(PLAYTIME_EDITOR, TRANSLATE("Day"), {"hcplaytimeday"}, "", 0, 50000, 0, 1, function(); end)
                    PLAYTIME_HOUR = menu.slider(PLAYTIME_EDITOR, TRANSLATE("Hour"), {"hcplaytimehour"}, "", 0, 50000, 0, 1, function(); end)
                    PLAYTIME_MIN = menu.slider(PLAYTIME_EDITOR, TRANSLATE("Min"), {"hcplaytimemin"}, "", 0, 50000, 0, 1, function(); end)
        ...
        local STAT_EDITOR = menu.list(STAT_EDITOR_READER, TRANSLATE("Custom Stat Editor") .. " " .. TRANSLATE("[Risky]"), {}, TRANSLATE("Setting some certain stats may cause a ban. Use at your own risk!"), function(); end)
            ...
            menu.divider(STAT_EDITOR, "Date")
                ...
                DATE_DAY = menu.slider(STAT_EDITOR, "Day", {"hceditday"}, "", 0, 31, 0, 1, function(); end)
                DATE_HOUR = menu.slider(STAT_EDITOR, "Hour", {"hcedithour"}, "", 0, 24, 0, 1, function(); end)
                DATE_MIN = menu.slider(STAT_EDITOR, "Min", {"hceditmin"}, "", 0, 60, 0, 1, function(); end)
...
--- Setting & About HC
    ...
    menu.divider(INFOS, TRANSLATE("Language"))
        ...
        menu.hyperlink(INFOS, TRANSLATE("How To Translate"), "https://icedoomfist.com/Stand_Heist_Control/How_To_Translate", TRANSLATE("Always looking for new translators not existing language. If you interested in translating HC, click!"))
    ...
    menu.divider(INFOS, TRANSLATE("Settings"))
        ...
        NOTIFICATION_SETTING = menu.list(INFOS, TRANSLATE("Notification") .. ": " .. READ_SETTING("Notification Sort"), {"hcnotification"}, "", function(); end)
            ...
            menu.divider(NOTIFICATION_SETTING, TRANSLATE("In-Game Customize"))
            ...
            menu.divider(NOTIFICATION_SETTING, TRANSLATE("Sort"))
    ...
    menu.divider(INFOS, TRANSLATE("About HC"))
        ...
        local CREDITS = menu.list(INFOS, TRANSLATE("Credits"), {"hccredit"}, "", function(); end)
            ...
            menu.divider(CREDITS, "jhowkNX")
                ...
                menu.hyperlink(CREDITS, "jhowkNx", "https://github.com/jhowkNx", TRANSLATE("2Take1 Heist Control Dev, He allowed me to use his code. Without him, HC doesn't exist. Really thanks to him!"))

            ---

            menu.divider(CREDITS, TRANSLATE("Heist Control"))

                menu.action(CREDITS, "Nowiri & Lance", {}, TRANSLATE("Creator of Wiriscript & Lancescript that help me coding HC"), function(); end)
                menu.action(CREDITS, "Baloo", {}, TRANSLATE("Helped a lot of stuffs for HC's website maintenance."), function();end)
                menu.action(CREDITS, "Zetax", {}, TRANSLATE("Helped me coding website's design."), function(); end)
                menu.action(CREDITS, "Aji", {}, TRANSLATE("Made logo, banner and etc for HC."), function(); end)
        ...
        menu.hyperlink(INFOS, TRANSLATE("Join Discord Server!"), "https://icedoomfist.com/Link/HC_Discord", TRANSLATE("Get support, Download beta version, Enjoy other stuffs!"))
        menu.hyperlink(INFOS, TRANSLATE("Youtube"), "https://icedoomfist.com/Link/HC_Youtube", TRANSLATE("Videos that related HC tutorial are uploaded, subscribe the channel for me, :D"))
        menu.hyperlink(INFOS, TRANSLATE("Tutorial"), "https://icedoomfist.com/Stand_Heist_Control/Tutorial", TRANSLATE("If you don't know how to use HC, click!"))
        menu.hyperlink(INFOS, TRANSLATE("Changelog"), "https://icedoomfist.com/Stand_Heist_Control/Changelog", TRANSLATE("If you want to know what latest version was changed, click!"))
